 ...
 */
final class Version20250405121607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ...
            , CONSTRAINT FK_70511A09111948DC FOREIGN KEY (deck_id) REFERENCES deck (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE flashcard (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, deck_id INTEGER DEFAULT NULL, front VARCHAR(255) NOT NULL, back VARCHAR(255) NOT NULL, image_type VARCHAR(10) NOT NULL, result VARCHAR(255) NOT NULL, unsplash_attribution CLOB NOT NULL, CONSTRAINT FK_70511A09111948DC FOREIGN KEY (deck_id) REFERENCES deck (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO flashcard (id, deck_id, front, back, image_type, result) SELECT id, deck_id, front, back, image_type, result FROM __temp__flashcard
        SQL);
